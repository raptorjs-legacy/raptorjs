...
var moduleDirs = [nodePath.join(__dirname, '../../../../src/main/resources/META-INF/resources/raptorjs_modules'), nodePath.join(__dirname, 'raptorjs_modules')];

var _coreModulesDir;

for (var i=0; i<moduleDirs.length; i++) {
    if (nodePath.existsSync(moduleDirs[i])) {
