...
function main() {
    ...
    try
    {
        ...
        { 
            Packages.java.lang.System.err.println(e.rhinoException.details());
            Packages.java.lang.System.err.println("Stack trace:");
            var stackTrace = e.rhinoException.getScriptStackTrace();
            if (stackTrace) {
                Packages.java.lang.System.err.println(e.rhinoException.getScriptStackTrace());
            }
            else {
