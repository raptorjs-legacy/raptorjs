 ...
 */
define.Class('raptor/templating/taglibs/core/AssignNode', 'raptor/templating/compiler/Node', ['raptor'], function (raptor, require) {
    'use strict';
    ...
    AssignNode.prototype = {
        doGenerateCode: function (template) {
            var varName = this.getProperty('var'), value = this.getProperty('value');
            if (!varName) {
