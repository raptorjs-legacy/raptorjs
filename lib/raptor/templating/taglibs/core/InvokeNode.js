 ...
 */
define.Class('raptor/templating/taglibs/core/InvokeNode', 'raptor/templating/compiler/Node', ['raptor'], function (raptor, require) {
    'use strict';
    ...
    InvokeNode.prototype = {
        doGenerateCode: function (template) {
            var func = this.getProperty('function'), funcDef, bodyParam, definedFunctions = template.getAttribute('core:definedFunctions');
            if (!func) {
