 ...
 */
define.Class('raptor/templating/taglibs/core/WriteNode', 'raptor/templating/compiler/Node', ['raptor'], function (raptor, require) {
    'use strict';
    var EscapeXmlContext = require('raptor/templating/compiler/EscapeXmlContext');
    ...
    WriteNode.prototype = {
        doGenerateCode: function (template) {
            var expression = this.getExpression(), escapeXml;
