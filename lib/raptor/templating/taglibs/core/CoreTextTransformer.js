 ...
 */
define.Class('raptor/templating/taglibs/core/CoreTextTransformer', ['raptor'], function (raptor, require) {
    'use strict';
    var ExpressionParser = require('raptor/templating/compiler/ExpressionParser'), TextNode = require('raptor/templating/compiler/TextNode'), WriteNode = require('raptor/templating/taglibs/core/WriteNode'), ScriptletNode = require('raptor/templating/taglibs/core/ScriptletNode');
    return {
