 ...
 */
define.Class('raptor/templating/taglibs/core/WithNode', 'raptor/templating/compiler/Node', ['raptor'], function (raptor, require) {
    'use strict';
    var AttributeSplitter = require('raptor/templating/compiler/AttributeSplitter'), varNameRegExp = /^[A-Za-z_][A-Za-z0-9_]*$/;
    ...
    WithNode.prototype = {
        doGenerateCode: function (template) {
            var vars = this.getProperty('vars'), _this = this;
            if (!vars) {
