 ...
 */
define.Class('raptor/templating/taglibs/core/TemplateNode', 'raptor/templating/compiler/Node', ['raptor'], function (raptor, require) {
    'use strict';
    ...
    TemplateNode.prototype = {
        doGenerateCode: function (template) {
            var name = this.getProperty('name'), params = this.getProperty('params');
            if (params) {
