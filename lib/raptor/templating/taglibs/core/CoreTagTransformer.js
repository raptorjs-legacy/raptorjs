...
define.Class('raptor/templating/taglibs/core/CoreTagTransformer', ['raptor'], function (raptor, require) {
    'use strict';
    var extend = raptor.extend, coreNS = 'http://raptorjs.org/templates/core', WriteNode = require('raptor/templating/taglibs/core/WriteNode'), ForNode = require('raptor/templating/taglibs/core/ForNode'), IfNode = require('raptor/templating/taglibs/core/IfNode'), ElseIfNode = require('raptor/templating/taglibs/core/ElseIfNode'), ElseNode = require('raptor/templating/taglibs/core/ElseNode'), WithNode = require('raptor/templating/taglibs/core/WithNode'), WhenNode = require('raptor/templating/taglibs/core/WhenNode'), OtherwiseNode = require('raptor/templating/taglibs/core/OtherwiseNode'), TagHandlerNode = require('raptor/templating/taglibs/core/TagHandlerNode'), IncludeNode = require('raptor/templating/taglibs/core/IncludeNode'), Expression = require('raptor/templating/compiler/Expression'), AttributeSplitter = require('raptor/templating/compiler/AttributeSplitter'), TypeConverter = require('raptor/templating/compiler/TypeConverter'), getPropValue = function (value, type, allowExpressions) {
    ...
    return {
        process: function (node, compiler, template) {
            ...
            var forEachAttr, ifAttr, elseIfAttr, attrsAttr, whenAttr, withAttr, escapeXmlAttr, parseBodyTextAttr, stripAttr, contentAttr, replaceAttr, inputAttr, forEachNode, uri, tag, nestedTag, forEachProp = function (callback, thisObj) {
                    node.forEachAttributeAnyNS(function (attr) {
                        ...
                        var type = attrDef ? attrDef.type || 'string' : 'string', value;
        ...
        handleAttr: function (node, compiler, template) {
            ...
            if (hasValue) {
                ...
                node.setEscapeXmlContext(require('raptor/templating/compiler/EscapeXmlContext').Attribute);
