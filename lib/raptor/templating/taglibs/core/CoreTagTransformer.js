                        ...
                        node.forEachAttributeAnyNS(function(attr) {
                            ...
                            if (attrDef) {
                                if (attrDef.targetProperty) {
                                    propName = attrDef.targetPropert;
                                }
                                else {
                                    propName = attr.localName;

                                    // propName = attr.localName.replace(/-([a-z])/g, function(match, lower) {
                            ...
                            var prevPropName = (attrDef && attrDef.targetProperty) || attr.localName;
                            if (prevPropName != propName) {
                                console.error("WARNING: OLD PROP NAME CHANGED: ", prevPropName + ' -> ' + propName);
                            }
