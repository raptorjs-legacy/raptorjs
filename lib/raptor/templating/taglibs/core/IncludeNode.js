 ...
 */
define.Class('raptor/templating/taglibs/core/IncludeNode', 'raptor/templating/compiler/Node', ['raptor'], function (raptor, require) {
    'use strict';
    var stringify = require('raptor/json/stringify'), extend = raptor.extend;
    ...
    IncludeNode.prototype = {
        doGenerateCode: function (template) {
            var templateName = this.getProperty('template'), templateData = this.getProperty('templateData') || this.getProperty('template-data'), resourcePath, _this = this;
            if (templateName) {
