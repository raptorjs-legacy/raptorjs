                ...
                forEach(_this.tag.nestedVariables, function(v) {
                    ...
                    if (v.nameFromAttribute) {
                        ...
                        for (var i=0,len=possibleNameAttributes.length; i<len; i++) {
                            v.name = this.getAttribute(possibleNameAttributes[i]);
                            if (v.name) {
                                break;
                            }
                        }
                        ...
                        if (!v.name) {
                            ...
                            v.name = "_var"; // Let it continue with errors
                        }
                        else {
                            this.removeProperty(v.nameFromAttribute);    
                        }
                    ...
                    template
                        ...
                        .indent(function() {
                            ...
                            if (_this.preInvokeCode.length) {
                                ...
                                if (!hasNamespacedProps) {
                                    // Need to add a placeholder argument for the namespaced props parameter before we add all of the pre-invoke code
                                    template
                                        .code(",\n")
                                        .indent()
                                        .code("0");
