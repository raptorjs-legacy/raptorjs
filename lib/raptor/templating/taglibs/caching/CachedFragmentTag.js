define('raptor/templating/taglibs/caching/CachedFragmentTag', function (require) {
    'use strict';
    return {
        render: function (input, context) {
            var attributes = context.attributes, cacheProvider = attributes.cacheProvider, cache, cachedHtml, cacheKey = input.cacheKey;
            if (!cacheKey) {
