define('raptor/templating/taglibs/optimizer/SlotTag', function (require, exports, module) {
    'use strict';
    var promises = require('raptor/promises'), logger = module.logger(), optimizer = require('raptor/optimizer');
    return {
