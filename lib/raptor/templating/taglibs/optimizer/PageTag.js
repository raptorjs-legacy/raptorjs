define('raptor/templating/taglibs/optimizer/PageTag', ['raptor'], function (raptor, require, exports, module) {
    'use strict';
    var packaging = require('raptor/packaging'), File = require('raptor/files/File'), resources = require('raptor/resources'), optimizer = require('raptor/optimizer'), logger = module.logger(), promises = require('raptor/promises');
