 ...
 */
define.Class('raptor/templating/compiler/TypeConverter', ['raptor'], function (raptor, require) {
    'use strict';
    var ExpressionParser = require('raptor/templating/compiler/ExpressionParser'), stringify = require('raptor/json/stringify'), Expression = require('raptor/templating/compiler/Expression');
    var TypeConverter = function () {
    };
    TypeConverter.convert = function (value, targetType, allowExpressions) {
        var hasExpression = false, expressionParts = [];
        if (value == null) {
            return value;
        }
