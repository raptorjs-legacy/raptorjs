 ...
 */
define.Class('raptor/templating/compiler/TaglibXmlLoader', ['raptor'], function (raptor, require, exports, module) {
    'use strict';
    var objectMapper = require('raptor/xml/sax/object-mapper'), regexp = require('raptor/regexp'), Taglib = require('raptor/templating/compiler/Taglib'), Tag = Taglib.Tag, Attribute = Taglib.Attribute, Property = Taglib.Property, NestedVariable = Taglib.NestedVariable, ImportedVariable = Taglib.ImportedVariable, Transformer = Taglib.Transformer, Function = Taglib.Function, HelperObject = Taglib.HelperObject, STRING = 'string', BOOLEAN = 'boolean', OBJECT = 'object';
    ...
    TaglibXmlLoader.prototype = {
        load: function () {
            var src = this.src, filePath = this.filePath, taglibResource = this.resource, tagsById = {}, handleTagExtends = function (subTag) {
                    ...
                    'raptor-taglib': {
                        ...
                        'import-taglib': {
                            ...
                            _end: function (importedTaglib) {
                                var path = importedTaglib.path, importedXmlSource, importedTaglibResource;
                                if (path.startsWith('/')) {
