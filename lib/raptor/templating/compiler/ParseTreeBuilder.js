 ...
 */
define.Class('raptor/templating/compiler/ParseTreeBuilder', ['raptor'], function (raptor, require, exports, module) {
    'use strict';
    var sax = require('raptor/xml/sax'), forEach = raptor.forEach, TextNode = require('raptor/templating/compiler/TextNode'), ElementNode = require('raptor/templating/compiler/ElementNode');
    ...
    ParseTreeBuilder.prototype = {
        parse: function (src, filePath, taglibs) {
            var logger = logger, parentNode = null, rootNode = null, prevTextNode = null, imports, parser = sax.createParser({
                    trim: false,
                    normalize: false,
            ...
            parser.on({
                ...
                startElement: function (el) {
                    prevTextNode = null;
                    var importsAttr, importedAttr, importedTag;
                    ...
                    forEach(el.getAttributes(), function (attr) {
                        var attrURI = taglibs.resolveURI(attr.getNamespaceURI()), attrLocalName = attr.getLocalName(), attrPrefix = attr.getPrefix();
