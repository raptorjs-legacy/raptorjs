 ...
 *
 */
define.Class('raptor/templating/compiler/AttributeSplitter', ['raptor'], function (raptor, require) {
    'use strict';
    var strings = require('raptor/strings'), TypeConverter = require('raptor/templating/compiler/TypeConverter'), regExp = /"(?:[^"]|\\")*"|'(?:[^']|\\')*'|==|===|[;=]/g;
    /**
     *
     */
    ...
    AttributeSplitter.parse = function (attr, types, options) {
        ...
        var partStart = 0, ordered = options.ordered === true, defaultName = options.defaultName, removeDashes = options.removeDashes === true, matches, equalIndex = -1, result = ordered ? [] : {}, handleError = function (message) {
