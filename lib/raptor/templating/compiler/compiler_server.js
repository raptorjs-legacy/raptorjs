 ...
 * @extension Server
 */
define.extend('raptor/templating/compiler', function (require, compiler) {
    'use strict';
    var logger = require('raptor/logging').logger('raptor/templating/compiler'), raptor = require('raptor'), resources = require('raptor/resources'), packaging = require('raptor/packaging'), discoveryComplete = false, searchPathListenerHandler = null, watchingEnabled = false, loadedTaglibPaths = {}, taglibsLastModified = null;
            ...
            function isUpToDate() {
                ...
                for (var i = 0, len = urls.length; i < len; i++) {
                    ...
                    if (url.startsWith('file://')) {
                        // Only supporting file URLs for now...
