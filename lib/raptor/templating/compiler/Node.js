 ...
 */
define.Class('raptor/templating/compiler/Node', ['raptor'], function (raptor, require) {
    'use strict';
    var forEachEntry = raptor.forEachEntry, isArray = Array.isArray, isEmpty = require('raptor/objects').isEmpty;
    ...
    Node.prototype = {
        ...
        addError: function (error) {
            var compiler = this.compiler, curNode = this;
        ...
        removeChild: function (childNode) {
            ...
            var previousSibling = childNode.previousSibling, nextSibling = childNode.nextSibling;
