 ...
 */
define('raptor/templating/compiler', function (require, exports, module) {
    'use strict';
    var TaglibCollection = require('raptor/templating/compiler/TaglibCollection'), taglibs = new TaglibCollection(), extend = require('raptor').extend, ExpressionParser = require('raptor/templating/compiler/ExpressionParser'), defaultOptions = {
            minify: false,
            preserveWhitespace: {
                'pre': true,
                'textarea': true
    ...
    return {
        createCompiler: function (options) {
            ...
            var TemplateCompiler = require('raptor/templating/compiler/TemplateCompiler');
