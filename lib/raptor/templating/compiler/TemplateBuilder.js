...
define.Class(
    ...
    function(raptor, require) {
        ...
        TemplateBuilder.prototype = {            
            ...
            addHelperFunction: function(className, functionName, bindToContext) {
                var classVarName = this.addClassNameVar(className);
                                
                if (bindToContext === true) {
                    this.addVar(functionName, "context.f(" + classVarName + "," + JSON.stringify(functionName) + ")");    
                }
                else {
                    this.addStaticVar(functionName, this.getStaticHelperFunction("getHelper", "h")  + "(" + classVarName + "," + JSON.stringify(functionName) + ")");
                } 
            },
