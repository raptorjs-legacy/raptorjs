 ...
 */
define.Class('raptor/templating/compiler/TemplateBuilder', ['raptor'], function (raptor, require) {
    'use strict';
    var INDENT = '  ';
    var stringify = require('raptor/json/stringify'), strings = require('raptor/strings'), Expression = require('raptor/templating/compiler/Expression'), forEach = raptor.forEach;
        ...
        flushMethodCalls: function () {
            ...
            if (_bufferedContextMethodCalls) {
                ...
                forEach(_bufferedContextMethodCalls, function (curWrite, i) {
                    var methodName = curWrite[0], args = curWrite[1];
                    if (i === 0) {
