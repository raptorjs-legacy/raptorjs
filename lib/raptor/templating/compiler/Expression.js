 ...
 */
define.Class('raptor/templating/compiler/Expression', ['raptor'], function (raptor, require) {
    'use strict';
    var operatorsRegExp = /"(?:[^"]|\\")*"|'(?:[^']|\\')*'|\s+(?:and|or|lt|gt|eq|ne|lt|gt|ge|le)\s+/g, strings = require('raptor/strings'), replacements = {
            'and': ' && ',
            'or': ' || ',
            'eq': ' === ',
            'ne': ' !== ',
