 ...
 */
define.Class('raptor/templating/compiler/ElementNode', 'raptor/templating/compiler/Node', ['raptor'], function (raptor, require) {
    'use strict';
    var forEachEntry = raptor.forEachEntry, forEach = raptor.forEach, objects = require('raptor/objects'), escapeXmlAttr = require('raptor/xml/utils').escapeXmlAttr, XML_URI = 'http://www.w3.org/XML/1998/namespace', XML_URI_ALT = 'http://www.w3.org/XML/1998/namespace', ExpressionParser = require('raptor/templating/compiler/ExpressionParser');
        ...
        generateBeforeCode: function (template) {
            ...
            this.forEachAttributeAnyNS(function (attr) {
                ...
                if (attr.value === null || attr.value === undefined) {
                    ...
                    var attrParts = [], hasExpression = false, invalidAttr = false;
