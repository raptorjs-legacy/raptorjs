define.Class('raptor/optimizer/Config', ['raptor'], function (raptor, require) {
    'use strict';
    var strings = require('raptor/strings'), BundleMappings = require('raptor/optimizer/BundleMappings'), promises = require('raptor/promises'), listeners = require('raptor/listeners'),
    ...
    Config.prototype = {
        ...
        addFilter: function (filter) {
            var filterFunc, filterThisObj, filterName, filterContentType;
        ...
        addServerSourceMapping: function (baseDir, urlPrefix) {
            this.serverSourceMappings.push({
                baseDir: baseDir,
                urlPrefix: urlPrefix
            });
        },
        ...
        createBundleMappings: function (bundleSetConfig, context) {
            var BundleSetConfig = require('raptor/optimizer/BundleSetConfig'), BundleConfig = require('raptor/optimizer/BundleConfig'), bundleMappings = new BundleMappings(context);
            var config = this, addBundles = function (o) {
                    var promise;
                    try {
                        if (o.enabled === false) {
                        } else if (o.ref) {
                            ...
                            promise = bundleMappings.addDependenciesToBundle(o.dependencies, bundleName, o.checksumsEnabled, o.wrappers);
