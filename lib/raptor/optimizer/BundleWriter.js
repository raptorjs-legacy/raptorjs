            ...
            writePageBundles: function(pageBundles, basePath) {
                ...
                var _this = this,
                    ...
                    writeBundle = function(bundle) {
                        ...
                        if (!bundle.isInline()) {
                            ...
                            logger.info('Bundle ' + bundle.getLabel() + ' written to disk in ' + (new Date().getTime() - startTime) + 'ms');
                        }
                ...
                pageBundles.forEachBundle(function(bundle) {
                    ...
                    if (bundle.isInline() && !bundle.inPlaceDeployment) {
                        ...
                        url = this.getBundleUrl(bundle, basePath || this.config.getBasePath());
                    ...
                    slotTracker.addContent(bundle.getSlot(), bundle.getContentType(), html, bundle.isInline());
