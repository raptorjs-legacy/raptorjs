        ...
        PageBundles.prototype = {
            ...
            build: function(async) {
                ...
                var optimizer = require('raptor/optimizer'),
                    ...
                    asyncPackages = [],
                    deferred = async ? promises.defer() : null,
                    isDone = false,
                    _this = this;
                    ...
                    handleDependency: function(dependency, context) {
                        ...
                        if (!bundle) {
                            ...
                            if (this.inPlaceDeploymentEnabled) {
                                ...
                                if (dependency.isInPlaceDeploymentAllowed() && sourceResource) {
                                    ...
                                    if (!this.sourceUrlResolver || sourceUrl) {
                                        bundle = bundleMappings.addDependencyToBundle(dependency, sourceResource.getURL());
                                        if (sourceUrl) {
                            ...
                            if (!bundle && (this.bundlingEnabled === false || this.inPlaceDeploymentEnabled)) {
                                ...
                                bundle = bundleMappings.addDependencyToBundle(dependency, targetBundleName);
                ...
                if (promise) {
                    ...
                    buildAsyncPageBundles();
                }
                
                if (async === false) {
                    if (!isDone) {
                        throw new Error("Asynchronous building of page bundles required.");
                    }
                    return this;
                }
                else {
