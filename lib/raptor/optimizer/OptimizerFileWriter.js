define.Class('raptor/optimizer/OptimizerFileWriter', ['raptor'], function (raptor, require, exports, module) {
    'use strict';
    var File = require('raptor/files/File'), logger = module.logger(), promises = require('raptor/promises'), FileUrlBuilder = require('raptor/optimizer/FileUrlBuilder');
    ...
    OptimizerFileWriter.prototype = {
        ...
        writeBundle: function (bundle) {
            ...
            try {
                ...
                readBundlePromise.then(function (bundleInfo) {
        ...
        writeBundleFile: function (outputFile, code, bundle) {
            var pageOptimizer = this.pageOptimizer, wrappers = pageOptimizer.bundleWrappers;
            if (wrappers) {
        ...
        writeResource: function (resource, context) {
            ...
            try {
                ...
                var outputDir = this.getOutputDir(), outputFile, checksum;
