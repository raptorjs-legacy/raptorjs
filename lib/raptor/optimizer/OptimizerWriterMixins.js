define('raptor/optimizer/OptimizerWriterMixins', ['raptor'], function (raptor, require, exports, module) {
    'use strict';
    var logger = module.logger(), promises = require('raptor/promises'), listeners = require('raptor/listeners');
    ...
    OptimizerWriterMixins.prototype = {
        ...
        writeBundles: function (iteratorFunc, onBundleWrittenCallback) {
            ...
            function onBundleFinished(bundle) {
                ...
                _this.publish('bundleWritten', { bundle: bundle });
            }
            try {
                iteratorFunc(function (bundle) {
                    ...
                    if (!promise) {
                        ...
                        if (bundle.isInline()) {
                            ...
                            promise = _this.pageOptimizer.readBundle(bundle, _this.context).then(function (bundleInfo) {
