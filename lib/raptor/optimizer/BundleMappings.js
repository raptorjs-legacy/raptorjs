define.Class(
    ...
    function(raptor, require, exports, module) {
        ...
        BundleMappings.prototype = {
            ...
            addDependenciesToBundle: function(dependencies, targetBundleName, checksumsEnabled, async) {
                async = async === true;
                ...
                var promise = optimizer.forEachDependency({
                    ...
                    handleDependency: function(dependency, context) {
                        ...
                        logger.info(leftPad(targetBundleName, 30) + ": " + indent(context.depth) + 'Added "' + dependency.toString() + '"');
