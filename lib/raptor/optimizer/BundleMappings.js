define.Class('raptor/optimizer/BundleMappings', ['raptor'], function (raptor, require, exports, module) {
    'use strict';
    var logger = module.logger(), packaging = require('raptor/packaging'), promises = require('raptor/promises'), indent = function (level) {
            var str = '';
    ...
    BundleMappings.prototype = {
        ...
        addDependenciesToBundle: function (dependencies, targetBundleName, checksumsEnabled, wrappers) {
            var optimizer = require('raptor/optimizer'), _this = this;
            var promise = optimizer.forEachDependency({
                    ...
                    handleDependency: function (dependency, context) {
                        ...
                        var bundle = this.addDependencyToBundle(dependency, targetBundleName, checksumsEnabled, context.slot, wrappers);
