                ...
                function handleManifest(manifest, parentPackage, recursive, depth, async) {
                    try
                    {
                        ...
                        if (recursive === true || depth <= 0) {
                            ...
                            manifest.forEachDependency(
                                function(type, packageDependency) {
                                    ...
                                    function handleCurrentDependency() {
                                        return handleDependency(packageDependency, manifest, recursive, depth+1, async || packageDependency.isAsync());
                                    }
                            ...
                            return promiseChain || alreadyResolved;
                        }
                        else {
                        ...
                        if (dependency.isPackageDependency()) {
                            ...
                            if (promises.isPromise(dependencyManifest)) {
                                return dependencyManifest.then(function(dependencyManifest) {
                                    return handleManifest(dependencyManifest, parentPackage, recursive, depth, async);
                                },
                                onError);
                            }
                            else {
