        ...
        var optimizer = {
            ...
            loadConfigXml: function(configFile, params) {
                ...
                if (config.isMinifyJsEnabled()) {
                    config.addFilter("raptor/optimizer/MinifyJSFilter");
                }

                if (config.isMinifyCssEnabled()) {
                    config.addFilter("raptor/optimizer/MinifyCSSFilter");
                }

                if (config.isResolveCssUrlsEnabled()) {
                    config.addFilter("raptor/optimizer/ResolveCSSUrlsFilter");
                }
