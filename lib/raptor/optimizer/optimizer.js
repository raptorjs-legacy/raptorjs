...
define(
    ...
    function(raptor, require, exports, module) {
        ...
        var forEach = raptor.forEach,
            ...
            OptimizerContext = require('raptor/optimizer/OptimizerContext'),
            CONTEXT_KEY = 'raptor/OptimizerContext';
        ...
        var optimizer = {
            ...
            getOptimizerContext: function(context) {
                ...
                return attributes[CONTEXT_KEY] || 
                    (attributes[CONTEXT_KEY] = new OptimizerContext(context));
            }
        }; //end optimizer
