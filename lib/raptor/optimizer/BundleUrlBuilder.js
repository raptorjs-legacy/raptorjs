define(
    ...
    function(raptor, require, exports, module) {
        ...
        var BundleUrlBuilder = function(urlPrefix, outputDir) {
        ...
        BundleUrlBuilder.prototype = {
            ...
            buildBundleUrl: function(bundle, basePath) {
                if (bundle.url) {
                    ...
                    return require('raptor/path').relative(basePath, bundle.sourceResource.getSystemPath());
                }
            ...
            getPrefix: function(basePath) {
                ...
                if (!prefix) {
                    if (basePath) {
                        ...
                        prefix = require('raptor/path').relative(fromPath, toPath) + '/';
