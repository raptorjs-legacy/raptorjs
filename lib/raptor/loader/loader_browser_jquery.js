            ...
            if (document.createStyleSheet) {
                ...
                if ("loaded" === readyState || "complete" === readyState) {
                    ...
                    detachEvents = function() {
                        if (!detached) {
                            success(); // Invoke the success callback before detaching... if already invoked then it will be a no-op
                            detached = true;
                            if (addEventListener) {
                                document.removeEventListener('load', onLoad);
                                document.removeEventListener('readystatechange', onReadyStateChange);
                    ...
                    window.setTimeout(300, detachEvents); // After 300ms, automatically detach events and invoke the success callback
                }
