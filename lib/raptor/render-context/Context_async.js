define.extend('raptor/render-context/Context', function (require) {
     ...
     */
    var StringBuilder = require('raptor/strings/StringBuilder'), dataProviders = require('raptor/data-providers'), promises = require.find('raptor/promises'), logger = require('raptor/logging').logger('raptor/render-context/Context'), DATA_PROVIDERS_CONTEXT_KEY = 'dataProviders', renderContext;
    ...
    return {
        beginAsyncFragment: function (callback, timeout) {
            ...
            var ready = true;
            // We'll optimistically assume this fragment is ready to be flushed
