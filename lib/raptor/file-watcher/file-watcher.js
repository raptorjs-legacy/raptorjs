define('raptor/file-watcher', ['raptor'], function (raptor, require, exports, module) {
    'use strict';
    var createFilenameMatcherFromPatterns = function (patterns) {
            var regExpArray = [], regexp = require('raptor/regexp');
    ...
    return {
        watchDir: function (dir, callback, thisObj, options) {
            ...
            if (options.recursive) {
                require('raptor/files/walker').walk(dir, function (dir) {
