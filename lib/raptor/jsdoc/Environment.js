define('raptor/jsdoc/Environment', [
    'raptor',
    'raptor/objects'
], function (raptor, objects, require, exports, module) {
    'use strict';
    var Type = require('raptor/jsdoc/Type'), Tag = require('raptor/jsdoc/Tag'), File = require('raptor/files/File'), SymbolSet = require('raptor/jsdoc/SymbolSet');
    ...
    Environment.prototype = {
        ...
        parseTag: function (tagName, value) {
            var TagClass = this.tagTypes[tagName], tag = null;
            if (TagClass) {
