define('raptor/jsdoc/CommentParser', function (require, exports, module) {
    'use strict';
    var Comment = require('raptor/jsdoc/Comment'), Tag = require('raptor/jsdoc/Tag'), strings = require('raptor/strings');
    ...
    CommentParser.prototype = {
        parse: function (text) {
            ...
            var description = [], curTagLines = null, curTagName = null, env = this.env, endTag = function () {
                    if (curTagName != null) {
