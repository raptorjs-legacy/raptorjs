define('raptor/jsdoc', ['raptor'], function (raptor, require, exports, module) {
    'use strict';
    var logger = module.logger(), esprima = require('esprima'), strings = require('raptor/strings'), SymbolSet = require('raptor/jsdoc/SymbolSet'), Environment = require('raptor/jsdoc/Environment'), ASTWalker = require('raptor/jsdoc/ASTWalker'), Comment = require('raptor/jsdoc/Comment'), CommentParser = require('raptor/jsdoc/CommentParser'), attachComments = function (ast, commentParser) {
            if (!ast.comments) {
                return;
            }
            var nodes = [];
