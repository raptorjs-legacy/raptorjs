define('raptor/jsdoc/Type', ['raptor'], function (raptor, require, exports, module) {
    'use strict';
    var INDENT = '  ', shortRegExp = /[\.\/]([^\.\/]*)$/;
    var Type = function (jsType, name) {
        this.properties = {};
        this.anonymous = false;
        this.functionParamNames = null;
        //Only valid when this type is a function
        this.functionParamsByName = null;
        this.parentScope = null;
        //Only valid when this type is a function scope
        this.localVarNames = {};
        //Only valid when this type is a function scope
        this.javaScriptType = jsType;
        //The primitive type of the JavaScript object. One of: function, object, boolean, number and string
        this.comment = null;
        //The jsdoc.Comment associated with the type
        this.instanceType = null;
        //Only valid when this type is a function
        this.name = name;
        //The name to use for display
        this.superclassName = null;
        //The symbol name of the superclass
        this.extension = null;
    };
    Type.prototype = {
                ...
                raptor.forEachEntry(prop, function (name, value) {
                    if (!currentProperty[name]) {
                        ...
                        if (value && value.instanceType) {
                            //See if the duplicate property has instance properties
                            /*
        ...
        toString: function (indent, context) {
            ...
            var keys = Object.keys(this.properties), propsStr = '', paramsStr = '', instancePropsStr = '', commentStr = '';
            if (this.getComment()) {
            ...
            if (keys.length) {
                ...
                propsStr = '\n' + indent + INDENT + propsLabel + '{\n' + keys.map(function (key) {
                    var prop = this.properties[key], commentStr = '';
                    if (prop.comment) {
