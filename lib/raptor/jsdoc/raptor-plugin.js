                ...
                env.getGlobal().addProperties({
                    "raptor": {
                        ...
                        "define": function(node, walker) {
                            return resolveDefine("define", node, walker);
                        },
                        
                        "define.Class": function(node, walker) {
                            return resolveDefine("define.Class", node, walker, true);
                        },
                        ...
                        "defineMixin": function(node, walker) {
                            return resolveDefine("defineMixin", node, walker);
                        },

                        "extendCore": function(node, walker) {
                            return resolveExtend("define.extendCore", node, walker);
                        },
                        
                        "extend": function(node, walker) {
                            return resolveExtend("define.extend", node, walker);
                        }     
                    }
                });
            }
