 ...
 *
 */
define('raptor/jsdoc/ASTWalker', ['raptor'], function (raptor, require, exports, module) {
    'use strict';
    var logger = module.logger(), arrays = require('raptor/arrays'), Type = require('raptor/jsdoc/Type');
    var toStrings = {
            Literal: function () {
    ...
    ASTWalker.prototype = {
        resolveMemberExpressionPropertyName: function (node) {
            var propertyNode = node.property, propName = null;
        ...
        walk_AssignmentExpression: function (node) {
            ...
            this.walk(rightNode);
            var parentType = null, targetPropName = null, resolvedType = null, existingType = null;
        ...
        walk_VariableDeclarator: function (node) {
            var scope = this.currentScope();
            var varName = node.id.name, type = null;
            if (node.init) {
        ...
        walk_MemberExpression: function (node) {
            ...
            if (objectType && propName) {
                //Check if the property is a static value
