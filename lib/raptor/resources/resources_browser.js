...
define.extend('raptor/resources', function (require) {
    'use strict';
    var Resource = require('raptor/resources/Resource'), MissingResource = require('raptor/resources/MissingResource'), BrowserResource = require('raptor/resources/BrowserResource');
    return {
