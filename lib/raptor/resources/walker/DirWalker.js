 ...
 */
define.Class('raptor/resources/walker/DirWalker', function (require) {
    'use strict';
    ...
    DirWalker.prototype = {
        ...
        _handleResource: function (resource) {
            var callbackThisObj = this.callbackThisObj, resourceFilter = this.resourceFilter, dirTraverseFilter = this.dirTraverseFilter;
