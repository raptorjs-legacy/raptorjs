 ...
 */
define.Class('raptor/resources/FileResource', 'raptor/resources/Resource', ['raptor'], function (raptor, require, exports, module) {
    'use strict';
    var files = require('raptor/files'), forEach = raptor.forEach;
    /**
     * @constructs
     */
    ...
    FileResource.prototype = {
        ...
        forEachChild: function (callback, thisObj) {
            ...
            forEach(filenames, function (filename) {
                var childResource = new FileResource(this.getSearchPathEntry(), this.getPath() == '/' ? '/' + filename : this.getPath() + '/' + filename, files.joinPaths(this.filePath, filename));
        ...
        getParent: function () {
            return new FileResource(this.getSearchPathEntry(), this.getDirPath(), this.getFile().getParent());
        },
        resolve: function (relPath) {
            ...
            return new FileResource(this.getSearchPathEntry(), resourcePath, absolutePath);
        },
        ...
        watch: function (callback, thisObj) {
            ...
            return fileWatcher.watch(this.filePath, callback, thisObj);
        }
    };
    return FileResource;
});