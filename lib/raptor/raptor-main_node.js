...
function installRaptor() {
    ...
    var File = raptor.require('raptor/files/File');
    var resources = raptor.require('raptor/resources');
    var searchPathEntry = resources.getSearchPath().addDir(new File(__dirname).getParent());
    raptor.setModuleSearchPath('raptor', searchPathEntry);
    ...
    var node_modulesDir = new File(path.join(__dirname, '../../../'));
    // Walk up three directories to find the "node_modules" dir
