 ...
 * @extension Node
 */
define.extend('raptor/files', function (require, exports, module) {
    'use strict';
    var nodePath = require('path'), nodeFs = require('fs'), File = require('raptor/files/File'), statSync = function (path) {
