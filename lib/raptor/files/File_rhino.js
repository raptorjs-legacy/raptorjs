 ...
 * @extension Rhino
 */
define.Class('raptor/files/File', ['raptor'], function (raptor, exports, module) {
    'use strict';
    ...
    function File(path) {
        ...
        if (arguments.length === 1) {
            ...
            var parent = arguments[0], child = arguments[1], parentJavaFile = null;
            if (!parent) {
    ...
    File.prototype = {
        ...
        isSymbolicLink: function () {
            ...
            if (!this.javaFie.getParent()) {
                ...
                javaCanonicalFile = new JavaFile(this.javaFile.getParentFile().getCanonicalFile(), this.javaFile.getName());
            }
        ...
        list: function () {
            var filenames = this.javaFile.list(), i = 0, len = filenames.length();
            for (; i < len; i++) {
