 ...
 */
define.Class('raptor/files/walker/DirWalker', function (require) {
    'use strict';
    ...
    DirWalker.prototype = {
        ...
        _handleFile: function (file) {
            var callbackThisObj = this.callbackThisObj, fileFilter = this.fileFilter, dirTraverseFilter = this.dirTraverseFilter;
