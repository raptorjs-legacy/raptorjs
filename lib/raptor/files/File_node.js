 ...
 * @extension Node
 */
define.Class('raptor/files/File', ['raptor'], function (raptor, require, exports, module) {
    'use strict';
    var nodePath = require('path'), nodeFS = require('fs'), existsSync = function (path) {
    ...
    function File(path) {
        if (arguments.length === 1) {
            ...
            var parentFile = arguments[0], childPath = arguments[1], parentPath;
            if (!parentFile) {
