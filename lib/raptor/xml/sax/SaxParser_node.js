...
define.Class('raptor/xml/SaxParser', 'raptor/xml/sax/BaseSaxParser', ['raptor'], function (raptor, require) {
    'use strict';
    var sax = require('sax'), extend = raptor.extend, arrays = require('raptor/arrays'), forEachEntry = raptor.forEachEntry;
    ...
    var SaxParser = function (options) {
        ...
        this.nodeParser = sax.parser(true, {
    ...
    SaxParser.prototype = {
        ...
        getPos: function () {
            var nodeParser = this.nodeParser, filePath = this.filePath;
