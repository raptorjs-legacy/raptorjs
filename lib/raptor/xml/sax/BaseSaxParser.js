 ...
 */
define.Class('raptor/xml/sax/BaseSaxParser', ['raptor'], function (raptor, require) {
    'use strict';
    var listeners = require('raptor/listeners'), arrayFromArguments = raptor.arrayFromArguments;
