 ...
 */
define('raptor/xml/dom-to-sax', ['raptor'], function (raptor, require, exports, module) {
    'use strict';
    ...
    Attribute.prototype = {
        ...
        toString: function () {
            return '[Attribute: ' + 'uri=' + this.getNamespaceURI() + ', qName=' + this.getQName() + ', value=' + this.getValue() + ']';
        }
    };
