 ...
 * enabled extensions.
 */
define('raptor/packaging/ExtensionCollection', ['raptor'], function (raptor, require) {
    'use strict';
    /**
     * @parent packaging_Server
     */
    var forEach = raptor.forEach, forEachEntry = raptor.forEachEntry, regexp = require('raptor/regexp');
    ...
    ExtensionCollection.prototype = {
        ...
        add: function (ext) {
            ...
            //Add the extension to a map for quick lookup
            this.extensionsArray.push(ext);
            //Maintain an array of extensions
