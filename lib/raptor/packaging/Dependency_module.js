    ...
    function(raptor, require, exports, module) {
        ...
        Dependency_module.prototype = {
            ...
            load: function(context) {
                ...
                if (!newManifest) {
                    throw new Error('Module not found with name "' + moduleName + '"');
                }
            ...
            getManifest: function() {
                ...
                if (!manifest) {
                    throw raptor.createError(new Error('Package manifest not found for module "' + this.name + '" in manifest "' + this.getParentManifestSystemPath() + '"'));    
                }
                return manifest;
            },
