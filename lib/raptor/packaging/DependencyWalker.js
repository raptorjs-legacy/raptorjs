define('raptor/packaging/DependencyWalker', function (require, module, exports) {
    'use strict';
    var packaging = require('raptor/packaging'), PackageManifest = require('raptor/packaging/PackageManifest'), ExtensionCollection = require('raptor/packaging/ExtensionCollection');
    function DependencyWalker() {
        this.options = { enabledExtensions: require('raptor/packaging').getEnabledExtensions() };
        this._visited = {};
