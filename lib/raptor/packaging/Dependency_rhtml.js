    ...
    function(require, exports, module) {
        ...
        Dependency_rhtml.prototype = {
            ...
            load: function(context) {
                ...
                require("raptor/templating/compiler").compileAndLoad(xmlSource, resource.getSystemPath());
            },
            ...
            getCode: function(context) {
                ...
                var xmlSource = resource.readAsString("UTF-8");
                var rhtmlJs = require("raptor/templating/compiler").compile(xmlSource, resource.getSystemPath());
                return rhtmlJs;
            },
