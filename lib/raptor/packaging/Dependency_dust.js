 ...
 */
define.Class('raptor/packaging/Dependency_dust', 'raptor/packaging/Dependency', function (require, exports, module) {
    'use strict';
    function getDust() {
        if (typeof exports !== 'undefined' && typeof process !== 'undefined') {
            return require('dustjs-linkedin');
        } else {
            return require.find('dustjs-linkedin') || require.find('dust');
        }
    }
