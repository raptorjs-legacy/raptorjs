 ...
 *
 * 
 * NOTE: Modifications were made to register the "q" module by name
 *       based on AMD specification. Original version of "q" is "0.9.6"
 *       -- Patrick Steele-Idem
 */
...
function done(promise, fulfilled, rejected, progress) {
    ...
    var onUnhandledError = function (error) {
        console.error("Q - UNHANDLED ERROR - ", stack);
