...
define.Class("raptor/logging/Logger", function(require) {
    ...
    function LogEvent(logger, logLevel, message, exception) {
        this.logger = logger;
    ...
    Object.defineProperty(Logger, "logging", {
        set: function(val) {
            logging = val;
        }
    });
    ...
    Logger.prototype = {
        ...
        trace: function(message, exception) {
            ...
            this._log(new LogEvent(this, LogLevel.TRACE, message, exception));
        },
        ...
        debug: function(message, exception) {
            this._update();
            if (this._level > 1) return;
            this._log(new LogEvent(this, LogLevel.DEBUG, message, exception));
        },
        ...
        info: function(message, exception) {
            ...
            this._log(new LogEvent(this, LogLevel.INFO, message, exception));
        },
        ...
        warn: function(message, exception) {
            ...
            this._log(new LogEvent(this, LogLevel.WARN, message, exception));
        },
        ...
        error: function(message, exception) {
            ...
            this._log(new LogEvent(this, LogLevel.ERROR, message, exception));
        },
        ...
        fatal: function(message, exception) {
            ...
            this._log(new LogEvent(this, LogLevel.FATAL, message, exception));
        },
