    ...
    function(raptor, require) {
        ...
        Widget.prototype = widgetProto = {
            ...
            appendTo: function(targetEl) {
                getEl(targetEl).appendChild(this._getRootEl());
            },
            ...
            replace: function(targetEl) {
                ...
                targetEl.parentNode.replaceChild(this._getRootEl(), targetEl);
            },
            ...
            replaceChildrenOf: function(targetEl) {
                targetEl = getEl(targetEl);
                targetEl.innerHTML = "";
                targetEl.appendChild(this._getRootEl());
            },
            ...
            insertBefore: function(targetEl) {
                targetEl = getEl(targetEl);            
                targetEl.parentNode.insertBefore(this._getRootEl(), targetEl);
            }, 
            ...
            insertAfter: function(targetEl) {
                ...
                if (nextSibling) {
                    targetEl.parentNode.insertBefore(this._getRootEl(), nextSibling);
                }
                else {
                    targetEl.parentNode.appendChild(this._getRootEl());
                }
            }, 
            ...
            prependTo: function(targetEl) {
                targetEl = getEl(targetEl);
                targetEl.insertBefore(this._getRootEl(), targetEl.firstChild || null);
            }
