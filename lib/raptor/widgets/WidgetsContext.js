define('raptor/widgets/WidgetsContext', ['raptor'], function (raptor, require, exports, module) {
    'use strict';
    ...
    WidgetsContext.prototype = {
        ...
        beginWidget: function (config, callback) {
            var _this = this, widgetStack = _this.widgetStack, lastWidgetIndex = widgetStack.length, parent = lastWidgetIndex ? widgetStack[lastWidgetIndex - 1] : null;
            if (!config.id) {
