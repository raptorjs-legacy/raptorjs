...
define.extend('raptor/widgets', function(require) {
    ...
    var stringify = require('raptor/json/stringify'),
        specialRegExp = /([^ -~]|(["'\\<]))/g,
        stringifyWidgetConfig = function(widgetConfig) {
            return widgetConfig ? stringify(widgetConfig, {special: specialRegExp}) : "0";
        };
    
    return {
        
        stringifyWidgetConfig: stringifyWidgetConfig,
        ...
        writeInitWidgetsCode: function(context, clearWidgets) {
            ...
            var write = function(str) {
                ...
                writeWidget = function(widget) {
                    ...
                    write(',');
                    write(stringifyWidgetConfig(widget.config));
                    if (widget.events) {
                        write(',[');
