exports.load = function (raptor) {
    ...
    if (!global.raptorExtendDefine) {
        ...
        var raptorWrapper = ' function define() { if (global.__raptor) { return global.__raptor._define(arguments, define.require); } } if (global.raptorExtendDefine) { global.raptorExtendDefine(define, module); }', Module = require('module').Module, wrapper = Module.wrapper, origWrapper0 = wrapper[0], originalFindPath = Module._findPath, raptorFindPath = function (request, paths) {
