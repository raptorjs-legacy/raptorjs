 ...
 *  
 *  Modified by Patrick Steele-Idem
 *  Original source: https://github.com/ringo/ringojs/blob/master/src/org/ringojs/wrappers/ScriptableList.java
 *  
 *  Change log:
...
public class ScriptableList extends NativeJavaObject {
    ...
    public void put(int index, Scriptable start, Object value) {
        if (list != null) {
            try {
                if (index == list.size()) {
                    list.add(RhinoUtils.jsToJava(value));
                } else {
                    list.set(index, RhinoUtils.jsToJava(value));
                }
            } catch (RuntimeException e) {
